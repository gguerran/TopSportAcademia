...
<div class="fh5co-parallax2" data-stellar-background-ratio="0.5" style='height: 300px'>
    ...
    <div class="container">
        <div class="fh5co-intro animate-box" style=" padding-top: 70px; text-align: center">
            <div class='col-md-12'>
                <h1 class="text-center">Lista de Saídas</h1>
                <br>
                <span><a class="btn btn-primary text-center" id='btn_modal' style="text-align: center"><i class="fa fa-plus" aria-hidden="true"></i>&ensp;Adicionar Saída</a></span>
            </div>
    ...
    <div class='modal-dialog' style='width: 500px;'>
        ...
        <div class='modal-content'>
            ...
            <div class="modal-body" style=" height: 170px">
                <form id='form-login' action='../controler/adiciona_saida.php' method='post' role='form' name='formPesquisa' style='text-align: center;'>

                    <div class='col-md-4'>
                        <!--<div class='form-group'>-->
                            <input type='text' class='form-control' id='nome' placeholder='Valor' name='valor'>
                            <br>
...
<footer id="footer" style="padding-top: 40px">
    ...
    if ($nivel == 1) {
        echo "<div class='container' style='text-align: left; align-items: center;'>
                    ...
                    <div class='col-md-8'>
                        <form id='form-login' action='lista_saida.php' method='post' role='form' name='formPesquisa' style='text-align: center;'>
