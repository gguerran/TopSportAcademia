    ...
    <div class="container">
        <div class="fh5co-intro animate-box" style=" padding-top: 70px; text-align: center">
            <div class='col-md-12'>
                ...
                <p>Valor Mensalidade: R$ <?php echo busca_valor_mensalidade($conexao)?>,00 </p>
                <span><a class="btn btn-primary text-center" id='btn_modal' style="text-align: center"><i class="fa fa-cog" aria-hidden="true"></i>&ensp;Alterar Valor de Mensalidade</a></span>
            </div>
            ...
            <div class="modal-body" style=" height: 170px">
                <form id='form-login' action='../controler/altera_mensalidade.php' method='post' role='form' name='formPesquisa' style='text-align: center;'>
                    ...
                    <div class='col-md-6'>
                        ...
                        <p>Valor antigo: R$ <?php echo busca_valor_mensalidade($conexao)?>,00</p> 
                            <br>
